...
import com.amigos.amigos.models.LoginDto
import com.amigos.amigos.models.UserSecurity
...
class JwtAuthenticationFilter(
    ...
    private val authenticationManaager: AuthenticationManager
) :
    ...
    override fun attemptAuthentication(req: HttpServletRequest, response: HttpServletResponse): Authentication {
        ...
        return authenticationManaager.authenticate(auth)
    }
